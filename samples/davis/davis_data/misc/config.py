...
__C.PHASE = phase.TRAINVAL

# Multiobject evaluation (Set to False only when evaluating DAVIS 2016)
__C.MULTIOBJECT = True

# Root folder of project
__C.PATH.ROOT = '/home/fothar/davis-2017/data'

# Data folder
__C.PATH.DATA = osp.abspath(osp.join(__C.PATH.ROOT, 'DAVIS'))
...
# Color palette
__C.PATH.PALETTE = osp.abspath(osp.join(__C.PATH.DATA, 'palette.txt'))

# Paths to files
__C.FILES = edict()

# Path to property file, holding information on evaluation sequences.
__C.FILES.DB_INFO = osp.abspath(osp.join(__C.PATH.DATA,"db_info.yaml"))
